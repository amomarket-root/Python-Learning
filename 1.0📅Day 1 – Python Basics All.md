...
Welcome to your **first day of Python learning**! This revised document includes a "▶️ Run Online" option after every coding example, letting you quickly copy and run code in an online compiler like [Programiz](https://www.programiz.com/python-programming/online-compiler) or [Replit](https://replit.com/~), plus more real-world scenarios. The code examples are complete and ready to run.
...
▶️ **Run Online:** This is a terminal command; not runnable in an online Python IDE.
